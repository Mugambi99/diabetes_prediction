...
def main():
    ...
    SkinThickness= st.text_input("Skin thickness value (in mm) (commonly observed values in the population)", value='23')
    Insulin= st.text_input("Insulin value")   
    BMI = st.text_input("Insert the calculated BMI value")
    DiabetesPedigreeFunction= st.text_input("DiabetesPedigreeFunction value (commonly observed values in the population)", value='0.47')
